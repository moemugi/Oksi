...
const signUpWithEmail = async () => {
  ...
  try {
    ...
    if (profileError) {
      ...
      setErrors((prev) => ({
        ...prev,
        username: 'Your account was created, but this username is taken. Please log in and update your profile.',
      }));
      setLoading(false);
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Inputs */}
      <View style={[styles.inputContainer, errors.username && { borderColor: 'red', borderWidth: 1 }]}>
        <Icon name="person" size={20} color="#666" style={styles.icon} />
        <TextInput placeholder="Username" value={username} onChangeText={setUsername} style={styles.input} />
      </View>
      {errors.username && <Text style={styles.errorText}>{errors.username}</Text>}

      <View style={[styles.inputContainer, errors.email && { borderColor: 'red', borderWidth: 1 }]}>
      ...
      <View style={[styles.inputContainer, errors.password && { borderColor: 'red', borderWidth: 1 }]}>
      ...
      <View style={[styles.inputContainer, errors.confirmPassword && { borderColor: 'red', borderWidth: 1 }]}>
        <Icon name="lock" size={20} color="#666" style={styles.icon} />
        <TextInput
      ...
      <Modal transparent={true} animationType="fade" visible={successModalVisible}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
           ...
           {/*<Text style={styles.modalText}>Please check your email for verification.</Text>*/}

            <TouchableOpacity
              style={[styles.modalButton, { backgroundColor: '#4CAF50', marginTop: 15 }]}
              onPress={() => {
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#2e6b34', paddingVertical: 12, borderRadius: 25, width: '100%', alignItems: 'center', marginTop: 20 },
